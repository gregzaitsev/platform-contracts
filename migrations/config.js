...
export function getFixtureAccounts(accounts) {
  ...
  return {
    INV_ETH_ICBM_NO_KYC: makeAccount(
      "0xFfF4c007c639aC627d7584A786DC793FBa8440d4",
      "investor",
      false,
    ),
    INV_EUR_ICBM_HAS_KYC: makeAccount(
      "0xfff70Ff1A8000a87f221639cD7e06A0809A73318",
      "investor",
      true,
    ),
    INV_ETH_EUR_ICBM_M_HAS_KYC: makeAccount(
      "0xffF73E00Ab5908403f7E6CbAF61154dB095D326d",
      "investor",
      true,
    ),
    INV_ETH_EUR_ICBM_M_HAS_KYC_DUP: makeAccount(
      "0xFfF904eD2313c76465B1FbF50ADbf5dcBB7245fD",
      "investor",
      true,
    ),
    INV_ICBM_ETH_M_HAS_KYC: makeAccount(
      "0xFFFe4C1dF6B319fEAc1aB848462Ae9948ae9BB3A",
      "investor",
      true,
    ),
    INV_ICBM_ETH_M_HAS_KYC_DUP: makeAccount(
      "0xFFF296bD0D5a877885A440aCf0d118E8F45273d3",
      "investor",
      true,
    ),
    INV_ICBM_EUR_M_HAS_KYC: makeAccount(
      "0xfFFC45a0da02323c44a5F1EBA94346e0E23D1a6f",
      "investor",
      true,
    ),
